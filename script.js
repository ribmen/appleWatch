...
function trocarImagem() {
    const idOpcaoSelecionada = document.querySelector('[name="opcao-imagem"]:checked').id; /* busque um elemento que tenha name = opcao-imagem E o estado checked */
    imagemSelecionada = idOpcaoSelecionada.charAt(0); /* pega o primeiro caractere desse id e use-o para atualizar a variável */
...
function trocarTamanho() {
    ...
    //innerHTML lida com elementos dentro de elementos
